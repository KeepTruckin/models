...
class SSDKTLaneMetaArch(model.DetectionModel):
  """SSD Meta-architecture definition."""
  ...
  def __init__(self,
    ...
    """
    super(SSDKTLaneMetaArch, self).__init__(num_classes=box_predictor.num_classes)
    self._is_training = is_training
    self._freeze_batchnorm = freeze_batchnorm
    self._inplace_batchnorm_update = inplace_batchnorm_update
    ...
    self._keypoint_predictor = keypoint_predictor
    ...
    self._keypoint_loss = keypoint_loss
    self._classification_loss_weight = classification_loss_weight
    self._localization_loss_weight = localization_loss_weight
    self._keypoint_loss_weight = keypoint_loss_weight
  ...
  def predict(self, preprocessed_inputs, true_image_shapes):
    ...
    if self._feature_extractor.is_keras_model:
      ...
      with slim.arg_scope([slim.batch_norm],
        ...
        with tf.variable_scope(None, self._extract_features_scope,
                               [preprocessed_inputs]):
          feature_maps, image_features = self._feature_extractor.extract_features_for_kt_lane(
              preprocessed_inputs)
    ...
    if self._box_predictor.is_keras_model:
      ...
      with slim.arg_scope([slim.batch_norm],
        ...
        keypoint_input = image_features['layer_7/output']
        keypoint_prediction_dict = self._keypoint_predictor.predict([keypoint_input])
    ...
    predictions_dict = {
        ...
        'lane_keypoints': keypoint_prediction_dict['lane_keypoint_predictions']
    }
  ...
  def postprocess(self, prediction_dict, true_image_shapes):
    ...
    with tf.name_scope('Postprocessor'):
      ...
      lane_keypoints = prediction_dict['lane_keypoints']
      ...
      detection_dict = {
          fields.LaneKeypointResultsFields.keypoints_heatmap:
              lane_keypoints,
  ...
  def loss(self, prediction_dict, true_image_shapes, scope=None):
    ...
    with tf.name_scope(scope, 'Loss', prediction_dict.values()):
      ...
      lane_keypoints_ground_truth = self.groundtruth_lists(fields.LaneListFields.lane_keypoints_heatmap)
      lane_keypoints_weights_ground_truth = self.groundtruth_lists(fields.LaneListFields.lane_keypoints_weights)
      lane_keypoint_losses = self._keypoint_loss(prediction_tensor=prediction_dict['lane_keypoints'],
                                                 target_tensor=lane_keypoints_ground_truth,
                                                 weights=lane_keypoints_weights_ground_truth)
      ...
      lane_keypoints_loss = tf.multiply((self._keypoint_loss_weight), lane_keypoint_losses,
                                        name='lane_keypoint_loss')

      loss_dict = {
          'Loss/localization_loss': localization_loss,
          'Loss/classification_loss': classification_loss,
          'Loss/keypoint_loss': lane_keypoints_loss
      }
